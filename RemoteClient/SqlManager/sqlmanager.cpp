...
bool SqlManager::insertAlarmRecord(QSqlDatabase db, QString host,int pass,int canId,int nodeType,int nodeSts,int alarmValue,int alarmTime)
{
...
bool SqlManager::insertHostList(QSqlDatabase db, QString host, QString port, QString num, QString able,QString address)
{
    QString sqlQuery = "insert into HOSTINFO values('"+host+"',"+port+","+num+","+able+",'"+address+"');";
